package com.sunrise.scmbhc.cache.preferences;
...
import com.sunrise.scmbhc.utils.coding.*;
...
public class Preferences {
	...
	private static final String ADDTIONAL_TARIFF_INFO = "addtional_tariff_info";
	...
	private final static String KEY_NO_NAME_TOKEN = "no_name_t";// 匿名token
	private static final String KEY_HOME_PAGE_GUIDE_VERSION = "homepage_guide_version";// 首页引导图片
	private static final String KEY_ASIAINFO_TOKEN = "asiaInfo_token";// 亚信token
	private static final String KEY_TOPUP_RATES = "topup rates";//利率
	
	private static SharedPreferences sSettingsPreferences;
	private static SharedPreferences sUdateInfosPreferences;
	private static Preferences instance;

	private CodingInterface mCodingObj;
	...
	public void clearUserInfo() {
		...
		editor.remove(ADDTIONAL_TARIFF_INFO);
	 ...
	 * @param string
	 */
	public void saveAdditionalTariffInfo(String string) {
		putString(ADDTIONAL_TARIFF_INFO, string);
	}

	/**
	 * @return 用户资费信息
	 */
	public String getAdditionalTariffInfo() {
		return getString(ADDTIONAL_TARIFF_INFO);
	}
	...
	private String encode(String str) {
		if (TextUtils.isEmpty(str))
			return str;
		return getCodingObject().encode(str);
	}
	...
	private String decode(String str) {
		if (TextUtils.isEmpty(str))
			return str;
		return getCodingObject().decode(str);
	 ...
	 * @param param
	 */
	public void setNonameToken(String param) {
		SharedPreferences.Editor editor = sSettingsPreferences.edit();
		if (TextUtils.isEmpty(param))
			editor.remove(KEY_NO_NAME_TOKEN);
		else
			editor.putString(KEY_NO_NAME_TOKEN, encode(param));
		editor.commit();
	}
	 ...
	 * @return 匿名token
	 */
	public String getNonameToken() {
		return decode(getString(KEY_NO_NAME_TOKEN));
	}
	...
	public String getAsiaInfoToken() {
		return getString(KEY_ASIAINFO_TOKEN);
	}
	
	public void setAsiaInfoToken(String asiaInfoToken) {
		putString(KEY_ASIAINFO_TOKEN, asiaInfoToken);
	}

	public void saveTopupRates(String rates) {
		putString(KEY_TOPUP_RATES, rates);
	}
	
	public String getTopupRates() {
		return getString(KEY_TOPUP_RATES);
	}
}
