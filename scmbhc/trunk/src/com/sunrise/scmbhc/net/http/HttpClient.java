package com.sunrise.scmbhc.net.http;
...
import com.sunrise.scmbhc.exception.http.HttpAuthException;
import com.sunrise.scmbhc.exception.http.HttpException;
import com.sunrise.scmbhc.exception.http.HttpRefusedException;
import com.sunrise.scmbhc.exception.http.HttpServerException;
...
public class HttpClient {
	...
	public String httpRequestStr(URI uri) throws HttpException {
		LogUtlis.showLogD(TAG, "uri" + uri.toString());
	...
	public String httpRequestStr(String url, List<NameValuePair> pairs) throws HttpException {
		...
		if (pairs != null) {
			...
			pairs.add(new BasicNameValuePair("app_version", String.valueOf(App.sAPKVersionCode)));
			pairs.add(new BasicNameValuePair("os", "Android"));
			// pairs.add(new BasicNameValuePair("signInfo",
			// CommUtil.getAppsign(App.sContext.getApplicationContext())));
		}
	...
	public void postData(String url, String data) throws ClientProtocolException, IOException, HttpException {
		LogUtlis.showLogD(TAG, "post data:" + data);
	...
	private URI convertRequestUrl(String url, List<NameValuePair> pairs) throws HttpException {
		...
		if (pairs != null) {
			...
			LogUtlis.showLogD(TAG, "requestParamsStr:" + url + "?" + requestParamsStr);
			String reauestParamsByBase4 = ZipAndBaseUtils.compressAndEncodeBase64(requestParamsStr, Base64.PREFERRED_ENCODING);
