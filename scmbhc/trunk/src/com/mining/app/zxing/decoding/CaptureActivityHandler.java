  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.restart_preview:
        LogUtlis.showLogD(TAG, "Got restart preview message");
        restartPreviewAndDecode();
        break;
      case R.id.decode_succeeded:
        LogUtlis.showLogD(TAG, "Got decode succeeded message");
        state = State.SUCCESS;
      ...
      case R.id.return_scan_result:
        LogUtlis.showLogD(TAG, "Got return scan result message");
        activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
        activity.finish();
        break;
      case R.id.launch_product_query:
        LogUtlis.showLogD(TAG, "Got product query message");
