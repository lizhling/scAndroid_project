...
public class NotificationPacketListener implements PacketListener {
    ...
    public void processPacket(Packet packet) {
        LogUtlis.showLogD(LOGTAG, "NotificationPacketListener.processPacket()...");
        LogUtlis.showLogD(LOGTAG, "packet.toXML()=" + packet.toXML());
        ...
        if (packet instanceof NotificationIQ) {
            ...
            if (notification.getChildElementXML().contains(
                ...
                String notificationOptionType = notification.getOptionType();
                String notificationOptionContent = notification.getOptionContent();
                ...
                intent.putExtra(Constants.NOTIFICATION_OPTION_TYPE, notificationOptionType);
                intent.putExtra(Constants.NOTIFICATION_OPTION_CONTENT, notificationOptionContent);
