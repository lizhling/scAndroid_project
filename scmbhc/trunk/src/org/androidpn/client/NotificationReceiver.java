...
public final class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        LogUtlis.showLogD(LOGTAG, "NotificationReceiver.onReceive()...");
        ...
        if (Constants.ACTION_SHOW_NOTIFICATION.equals(action)) {
            ...
            String notificationOptionType = intent.getStringExtra(Constants.NOTIFICATION_OPTION_TYPE);
            String notificationOptionContent = intent.getStringExtra(Constants.NOTIFICATION_OPTION_CONTENT);
            
            LogUtlis.showLogD(LOGTAG, "notificationId=" + notificationId);
            LogUtlis.showLogD(LOGTAG, "notificationApiKey=" + notificationApiKey);
            LogUtlis.showLogD(LOGTAG, "notificationTitle=" + notificationTitle);
            LogUtlis.showLogD(LOGTAG, "notificationMessage=" + notificationMessage);
            LogUtlis.showLogD(LOGTAG, "notificationUri=" + notificationUri);
            LogUtlis.showLogD(LOGTAG, "notificationOptionType="+notificationOptionType);

            Notifier notifier = new Notifier(context);
            notifier.notify(notificationId, notificationApiKey,
                    notificationTitle, notificationMessage, notificationUri, notificationOptionType, notificationOptionContent);
        }
        ...
        //
        //            LogUtlis.e(LOGTAG, "notificationId=" + notificationId);
        //            LogUtlis.e(LOGTAG, "notificationApiKey=" + notificationApiKey);
        //            LogUtlis.e(LOGTAG, "notificationTitle=" + notificationTitle);
        //            LogUtlis.e(LOGTAG, "notificationMessage=" + notificationMessage);
        //            LogUtlis.e(LOGTAG, "notificationUri=" + notificationUri);
        //
