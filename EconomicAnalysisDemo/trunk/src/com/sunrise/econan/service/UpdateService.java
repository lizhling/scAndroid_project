package com.sunrise.econan.service;
...
import com.sunrise.econan.cache.download.DownLoadThread;
...
public class UpdateService extends Service {
	...
	private void downloadApk() throws IOException {
		...
		if (downLoadUrl != null)
			EconomicAlaysisApp.sDownFileManager.downFile(this, updateInfo.getDownloadUrl(), ExtraKeyConstant.APP_FILE_APK_DIR, ExtraKeyConstant.APP_FILE_APK_NAME,
