...
import com.sunrise.econan.task.LoginTask;
import com.sunrise.econan.task.TaskListener;
import com.sunrise.econan.task.TaskResult;
import com.sunrise.econan.ui.view.DefaultInputDialog;
import com.sunrise.econan.ui.view.DefaultListDialog;
import com.sunrise.econan.ui.view.DefaultInputDialog.OnConfirmListener;
import com.sunrise.econan.ui.view.EditTextWacher;
...
public class LoginActivity extends BaseActivity implements OnClickListener, TaskListener, OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mArrayAccount = loadLoginAccount();
		{
			...
			mPhoneNumber.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, mArrayAccount));
		...
		{// 显示版本号
			...
			text.setText("V"+ EconomicAlaysisApp.sAppName);
		}
		{
	...
	private void checkCode() {
		...
		getPreferences().saveUserInfo(account, password);
