...
public class JavascriptHandler extends Handler {
	...
	/*
	 * public static final int JAVASCRIPT_GET_MANUFACTURER =6; public static
	 * final int JAVASCRIPT_GET_MODEL =7; public static final int
	 * JAVASCRIPT_GET_OS =8; public static final int JAVASCRIPT_GET_IMSI =9;
	 * public static final int JAVASCRIPT_GET_IMEI =10; public static final int
	 * JAVASCRIPT_GET_CELLID =11; public static final int JAVASCRIPT_GET_LAC
	 * =12; public static final int JAVASCRIPT_GET_LATITUDE =13; public static
	 * final int JAVASCRIPT_GET_LONGITUDE =14;
	 */
	...
	public JavascriptHandler(JavaScriptWebView mJavaScriptWebView) {
		...
		this.mJavaScriptWebView.removeJavascriptInterface("accessibility");
		this.mJavaScriptWebView.removeJavascriptInterface("ccessibilityaversal");
		this.mJavaScriptWebView.removeJavascriptInterface("searchBoxJavaBridge_");
	}
	...
	public void handleMessage(Message msg) {
		...
		case JAVASCRIPT_GET_PREFERENCE_WITH_KEY:
			...
			break;
		/*
		 * case JAVASCRIPT_GET_IMEI: getIMEIBack(params, mJavaScriptWebView);
		 * break; case JAVASCRIPT_GET_IMSI: getIMSIBack(params,
		 * mJavaScriptWebView); break; case JAVASCRIPT_GET_LAC:
		 * getLACBack(params, mJavaScriptWebView); break; case
		 * JAVASCRIPT_GET_LOCATIONGPS: getLocationGPSBack(params,
		 * mJavaScriptWebView); break; case JAVASCRIPT_GET_LATITUDE:
		 * getLatitudeBack(params, mJavaScriptWebView); break; case
		 * JAVASCRIPT_GET_CELLID: getLocationCellIDBack(params,
		 * mJavaScriptWebView); break; case JAVASCRIPT_GET_LONGITUDE:
		 * getLongitudeBack(params, mJavaScriptWebView); break; case
		 * JAVASCRIPT_GET_MANUFACTURER: getManufacturerlocationBack(params,
		 * mJavaScriptWebView); break; case JAVASCRIPT_GET_MODEL:
		 * getModelBack(params, mJavaScriptWebView); break; case
		 * JAVASCRIPT_GET_OS: getOSBack(params, mJavaScriptWebView); break;
		 */
		...
		case JAVASCRIPT_READ_SIM_CARD:
			...
			break;
		case JAVASCRIPT_WRITE_SIM_CARD:
			requestWriteSIMCardCallBack(params, mJavaScriptWebView);
			break;
		...
		case JAVASCRIPT_API_CALL_BACK:
			...
			break;
		case JAVASCRIPT_START_ANOTHER_METHOD:
			System.out.println("JAVASCRIPT_START_ANOTHER_METHOD:" + params[0]);
			mJavaScriptWebView.loadUrl(params[0]);
			break;
		}
	}
	 ...
	 * @param params
	 */
	private static void requestWriteSIMCardCallBack(String[] params, WebView webView) {
		String javascriptMethod = JavaScriptWebView.appendParamTOjavaScript(params, JavaScriptConfig.REQUEST_WRITE_SIM_CARD_REQUEST_CALL_BACK);
		webView.loadUrl(javascriptMethod);
	}
