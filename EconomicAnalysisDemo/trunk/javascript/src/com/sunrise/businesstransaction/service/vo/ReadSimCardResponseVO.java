...
public class ReadSimCardResponseVO extends ResponseVO {
	...
	//PAD收：68 0C 00 68   28        67   00 00    01           14 00    38 39 38 36 30 30 34 30 30 39 31 30 31 31 33 30 39 34 32 35 	   02 01 00 00   03 01 00 00    13 31 0A 01 04 0C  40  16
	//                   控制域      类型标识  地址域   01SIM卡ICCID     20字节  ICCID值为：89860040091011309425                                      02备用1 长度1 03备用2  长度1          时标                                       CRC
	
	public ReadSimCardResponseVO(String hex) {
		super(hex);
		...
		start +=2;
		this.iccid = StringConverter.getStringFromArr(start, (start + iccidLength), responseStringArr);
