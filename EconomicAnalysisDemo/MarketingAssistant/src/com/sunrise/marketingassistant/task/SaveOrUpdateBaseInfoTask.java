...
public class SaveOrUpdateBaseInfoTask extends GenericTask implements ExtraKeyConstant {

	public final SaveOrUpdateBaseInfoTask execute(String jsonStr,TaskListener listener) {
	...
	protected TaskResult _doInBackground(TaskParams... params) {
		...
		String result = null;
		try {
			result = ServerClient.getInstance().saveOrUpdateBaseInfo(jsonStr);
