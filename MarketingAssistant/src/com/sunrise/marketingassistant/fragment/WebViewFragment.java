...
//import com.sunrise.marketingassistant.cache.download.DownFileManager;
//import com.sunrise.marketingassistant.cache.download.DownLoadThread;
//import com.sunrise.marketingassistant.cache.preference.Preferences;
//import com.sunrise.marketingassistant.utils.FileUtils;
...
//				if (isOpenWebViewInFragment && !isContainWebActivity) {
...
//						clearWebDatas();
//						try {
//							DownFileManager.getInstance().downFile(mActivity, mUrl, ExtraKeyConstant.APP_FILE_HTML_DATA_DIR, mFileName, mHandler, true, false);
//						} catch (IOException e) {
...
//	/**
//	 * 是否在fragment中打开webview
//	 */
//	private boolean isOpenWebViewInFragment;
//
...
//			mBusinessInformation.setPhoneSimCardNumber(HardwareUtils.getPhoneNumber(mActivity));
//			mBusinessInformation.setHelpId(mHelpId);
//			mBusinessInformation.setAppVersion(App.sAppName);
...
//				DownFileManager.getInstance().downFile(mActivity, url, ExtraKeyConstant.APP_FILE_HTML_DATA_DIR, mFileName, handler, true, false);
//			}
//		} else {
//			mWebLoadStatus.setText("页面下载中0%");
//			DownFileManager.getInstance().downFile(mActivity, url, ExtraKeyConstant.APP_FILE_HTML_DATA_DIR, mFileName, handler, true, false);
...
//
//	/*
//	 * public void setSubAccount(String mSubAccount) { this.mSubAccount =
//	 * mSubAccount; }
//	 */
//
//	public void doback() {
