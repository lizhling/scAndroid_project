...
public class RewardInverseDetailTask extends GenericTask implements ExtraKeyConstant {

	public final RewardInverseDetailTask execute(String jsonStr,TaskListener listener) {
	...
	protected TaskResult _doInBackground(TaskParams... params) {
		...
		String result = null;
		try {
			result = ServerClient.getInstance().getRewardInverseDetail(jsonStr);
