...
public class GetRewordDetailTask extends GenericTask implements ExtraKeyConstant {
	public final GetRewordDetailTask execute(String json, TaskListener listener) {
	...
	protected TaskResult _doInBackground(TaskParams... params) {
		...
		String result = null;
		try {
			result = ServerClient.getInstance().getRewardDetail(json);
