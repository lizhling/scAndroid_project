...
public class UploadImageTask extends GenericTask implements ExtraKeyConstant {

	public final UploadImageTask execute(String jsonStr,TaskListener listener) {
	...
	protected TaskResult _doInBackground(TaskParams... params) {
		...
		String result = null;
		try {
			result = ServerClient.getInstance().uploadInfoImg(jsonStr);
