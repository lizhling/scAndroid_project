...
public class SaveOrUpdateActivityInfoTask extends GenericTask implements ExtraKeyConstant {

	public final SaveOrUpdateActivityInfoTask execute(String jsonStr,TaskListener listener) {
	...
	protected TaskResult _doInBackground(TaskParams... params) {
		...
		String result = null;
		try {
			result = ServerClient.getInstance().saveOrUpdateActInfo(jsonStr);
