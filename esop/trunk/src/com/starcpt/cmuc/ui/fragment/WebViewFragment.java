...
public class WebViewFragment extends Fragment {
	...
	private void setBusinessInformation() {
		if (mBusinessId != -1) {
			mBusinessInformation = new BusinessInformation(cmucApplication.getSettingsPreferences().getAuthentication(), mBusinessId + "",
					cmucApplication.getPhoneIMEI(), cmucApplication.getPhoneIMSI(), mAppTag);
