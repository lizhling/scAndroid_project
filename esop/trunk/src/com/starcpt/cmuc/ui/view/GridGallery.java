...
import com.starcpt.cmuc.ui.view.HorizontalScrollPanel.OnViewChangedListener;
...
public class GridGallery extends RelativeLayout implements OnViewChangedListener{
	...
	public GridGallery(Context context, AttributeSet attrs) {
		...
		numbersOfPage=array.getInteger(R.styleable.GridGallery_numbersOfPage, 9);
   ...
   public void initGallery(ArrayList<Item> datas,int numColumns){
		...
		private GridView createView(ArrayList<Item> datas,int numberOfPage,int pageIndex,int numColumns){
			...
			final List<Item> subList=gridViewAdapter.getSubList();
		...
		public interface ChildGridViewItemClickListener {
             void onItemClik(AdapterView<?> arg0, View arg1, int position,long id,List<Item> list);
		}

		public interface ChildGridViewItemLongClickListener {
            void onItemLongClick(AdapterView<?> arg0, View arg1, int position,long id,List<Item> list);
		}
