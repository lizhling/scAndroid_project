...
public class DownLoadThread extends Thread {
	...
	public DownLoadThread(Context context, String downloadUrl, String saveDir,
			String fileName, Handler handler, boolean isSaveFile, boolean isCach) {
		super();
	...
	protected void down() {
		...
		finish=true;
		Message msg=mHandler.obtainMessage(DWONLOAD_FLIE_ERROR);
		if(!isError){
