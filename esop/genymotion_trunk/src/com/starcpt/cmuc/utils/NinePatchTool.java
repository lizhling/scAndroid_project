...
public class NinePatchTool {
	...
	public static Drawable decodeDrawableFromFile(Context context,
			String filePath) throws SecurityException, IllegalArgumentException, IOException, NoSuchFieldException, IllegalAccessException  {
		Bitmap bm = decodeFromFile(filePath);
		if (null == bm.getNinePatchChunk()) {
			BitmapDrawable bitmapDrawable = new BitmapDrawable(bm);
			return bitmapDrawable;
		} else {
	...
	public static Bitmap decodeFromStream(InputStream in) throws IOException, SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException  {
	...
	public static Bitmap decodeFromFile(String path) throws IOException, SecurityException, IllegalArgumentException, NoSuchFieldException, IllegalAccessException {
