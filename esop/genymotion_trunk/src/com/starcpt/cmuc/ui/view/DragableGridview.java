...
//			this.invalidate();
	...
	private void startDragging() {
		...
		if (dragedItemIndex != -1) {
			...
			mDeleteLayoutParams.y = cmucApplication.getStatusBarHeight();
			mDeleteLayoutParams.height =DELETE_PANEL_HEIGHT;
			mDeleteLayoutParams.width = WindowManager.LayoutParams.FILL_PARENT;	
			
			if(mDeleteRect==null)
			mDeleteRect=new Rect(mDeleteLayoutParams.x, mDeleteLayoutParams.x, mDeleteLayoutParams.x+cmucApplication.getRealScreenWidth(), mDeleteLayoutParams.y+mDeleteLayoutParams.height);
