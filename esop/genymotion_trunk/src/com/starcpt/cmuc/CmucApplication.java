...
/*	public boolean isDisplayBusinessGuide() {
		return isDisplayBusinessGuide;
	}
	...
	public void setFunctionGuideDrawables(
			ArrayList<Drawable> mFunctionGuideDrawables) {
	...
	public void setBusinessGuideDrawables(
			ArrayList<Drawable> mBusinessGuideDrawables) {
		...
		try {
		     ...
		     if(appMetaData!=null){
				 ...
				 if(appTags.length>1){
					 ...
					 mAppSplashNameId=sAppSplashNames.get(mAppTag);
