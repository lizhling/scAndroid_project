...
public class AppMenuBean {
	...
	public AppMenuBean(String name, String content, int businessId, String icon, String appTag) {
		super();
		this.name = name;
	...
	public String getThreePackageName() {
		return threePackageName;
	}

	public void setThreePackageName(String threePackageName) {
		this.threePackageName = threePackageName;
	}
